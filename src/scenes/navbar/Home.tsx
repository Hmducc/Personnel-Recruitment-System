...
export default function Home() {
  return (
    <div className="bg-red-100">
      <div className="bg-blue-400 h-screen  background">
        <div className="slogan">
          <h1 className=" text-6xl absolute">
            <span>From</span>
            <span className="ml-3 text-green-400">College</span>
            <span className="ml-3">to</span>
            <span className="ml-3 text-green-400">Corporations</span>
            <br></br>
            <span>in a touch!</span>
          </h1>
        </div>
